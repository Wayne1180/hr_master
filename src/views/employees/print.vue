    ...
    <div class="app-container">
      <el-card>
        ...
        <el-row type="flex" justify="end">
          <el-button size="mini" type="primary" v-print="printObj"
            >打印</el-button
          >
        </el-row>
...
<script>
import { reqPersonalDetail, reqJobDetail } from "@/api/employees";
...
export default {
  ...
  methods: {
    async getPersonalDetail() {
      this.formData = await reqPersonalDetail(this.userId); // 获取个人基本信息
    },
    async getJobDetail() {
      const userInfo = await reqGetUserDetailById(this.userId);
      const jobInfo = await reqJobDetail(this.userId); // 获取个人基本信息
